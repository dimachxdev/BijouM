...
function ajouterClient(){
  ...
  const id=nextId('CL','cl');var cliObj={id,nom,tel,email,adresse};STATE.clients.unshift(cliObj);save();saveClient(cliObj);renderClients();closeModal('modal-add-client');['c-nom','c-tel','c-email','c-adresse'].forEach(x=>document.getElementById(x).value='');showToast(`✓ Client "${nom}" ajouté.`);
}
