...
function ajouterProduit(){
  ...
  STATE.stock.unshift({ref,nom,carat,type,typeBijou:typeBijouP,provenance:prov,poids:poids,qty:qty,poidsTotalG:poids,prix,seuil});save();renderStocks();closeModal('modal-add-produit');showToast('✓ Article ajouté.');
}
...
function validerAjustStock(){
  ...
  save();closeModal('modal-ajust-stock');renderStocks();
...
function enregistrerSortie(){
  ...
  STATE.sorties.unshift({id,date,typeBijou:labelType,carat:carat||'—',poids:poidsSort,nbArticles:nbArticles||0,motif,commentaire,validePar:'admin'});
